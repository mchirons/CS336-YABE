...
<%
		...
		<div class="header">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<h1><a href="HomePage.jsp" id="logo"><span id="y">Y</span><span id="a">A</span><span id="b">B</span><span id="e">E</span></a> Car Details</h1>
					</div>
					<div class="col-md-6">
						<ul>
		...
		<hr/>
		<div class ="container">
		<form action="InsertCars.jsp" method="GET" id="cars-form">
			<div class="form-group row">
 		 <label for="example-text-input" class="col-xs-2 col-form-label">Bid Title</label>
  			<div class="col-xs-10">
    			<input class="form-control" type="text" placeholder="e.g. Fancy car" name="bidtitle" id="bidtitle">
 				 </div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
  				...
  				<div class="col-xs-10">
    			<input class="form-control" type="text" placeholder="Type the color of your car" name="color" id="color">
  				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
  				...
  				<div class="col-xs-10">
    			<input class="form-control" type="text" placeholder="Acura\Alfa Romeo\Aston Martin\Audi\Bentley\BMW\Bugatti\Buick...." name="manufacturer" id="manufacturer">
 				 </div>
			</div>
			<div class="form-group row">
 		 		<label for="example-text-input" class="col-xs-2 col-form-label">Model</label>
  				<div class="col-xs-10">
    			<input class="form-control" type="text" placeholder="Type Car Model" name="model" id="model">
 				 </div>
			</div>
			<div class="form-group row">
  				<label for="example-month-input" class="col-xs-2 col-form-label">year</label>
  				<div class="col-xs-10">
    			<input class="form-control" type="year" placeholder="Type year of the car" name="year" id="year">
  				</div>
			</div>
			<div class="form-group row">
  				<label for="example-number-input" class="col-xs-2 col-form-label">Doors</label>
  				<div class="col-xs-10">
    			<input class="form-control" type="number" placeholder="Type how many doors the car have" name="door" id="door">
  				</div>
			</div>
			<div class="form-group row">
  				<label for="example-number-input" class="col-xs-2 col-form-label">Seats</label>
  				<div class="col-xs-10">
    			<input class="form-control" type="number" placeholder="Type how many seats the car have" name="seats" id="seats">
  				</div>
			</div>
			<div class="form-group row">
