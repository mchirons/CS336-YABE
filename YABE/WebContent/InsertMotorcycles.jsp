...
<html>
	...
	<body>
			<%
				...
				String handlebartype = request.getParameter("handlebartype");
				String seattype = request.getParameter("seattype");
				String img = request.getParameter("picture");
				
				
				boolean InsertMotorcycles = dao.InsertMotorcycles(userID,bidtitle,closetime,color,horsepower,mileage,mpg,manufacturer,model,year,handlebartype,seattype,img);
		
				if (InsertMotorcycles)
