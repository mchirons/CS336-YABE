...
<html>
	...
	<body>
			<%
				...
				String towcapacity = request.getParameter("towcapacity");
				String clearance = request.getParameter("clearance");
				String img = request.getParameter("picture");
				
				
				boolean InsertTrucks = dao.InsertTrucks(userID,bidtitle,closetime,color,horsepower,mileage,mpg,manufacturer,model,year,door,seat,height,towcapacity,clearance,img);
